...
const HEADING_ICONS: [RegExp, string][] = [
  ...
  [/tool|skill|plugin|mcp|harness/i,                    'puzzle'],
  [/drill|hire two|handoff|@mention/i,                  'clipboard-check'],
  [/stretch|specifies other|bot hr/i,                   'wand-sparkles'],
  [/roster|receipt|template|artifact/i,                 'file-text'],
  [/group chat|group room/i,                            'network'],
